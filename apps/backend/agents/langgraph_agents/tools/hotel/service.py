...
from agents.langgraph_agents.tools.hotel.normalize import normalize_hotels
from agents.nlp.hotel_intent_extractor import extract_hotel_intent
from agents.postprocessing.hotel_enrichment import enrich_hotels, EnrichmentResult
...
def search_hotels(
    ...
    *,
    ...
    try:
        ...
        raw_hotels = search_hotels_api(city_iata=city_iata, adults=guests)
        ...
        if hotels and (preferences or len(hotels) > 1):
            ...
            try:
                ...
                logger.warning(f"Enrichment failed: {e}, returning basic results")
